  ...
  return(
    <div>
      <Box>
        <div>
          First:
          <input onChange={ (e)=>setFirst(e.target.value)} value={first}></input>
        </div>
        <div>
          Second:
          <input onChange={ (e)=> setSecond(e.target.value)} value={second}></input>
         </div>
    ...
    <WithoutMemo first={first} second={second}>
