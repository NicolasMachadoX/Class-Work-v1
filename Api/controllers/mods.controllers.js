const Collection = require('../mods/User.js');
...
module.exports = {
    getAll,post,getByID,deleteById,updateById, getByName, getByCode, getByDescription, getByCategory, getDescriptionByCode
}