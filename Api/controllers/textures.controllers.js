const Collection = require('../models/Textures.js');
...
module.exports = {
    getAll,post,getByID,deleteById,updateById, getByName, getByCode, getByCategory, getByShaders, getByVersion, getDescriptionByCode
}